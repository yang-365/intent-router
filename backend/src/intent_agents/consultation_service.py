"""Consultation agent service — answers banking FAQ questions."""
...
class ConsultationAgentRequest(BaseModel):
...
class ConsultationAgentService:
    def __init__(self) -> None:
        self.skill = ConsultationSkill()

    async def handle(self, request: ConsultationAgentRequest) -> AgentExecutionResponse:
        ...
        result = await self.skill.execute(
            slot_memory,
            context={
                "cust_id": request.customer.cust_id or "",
